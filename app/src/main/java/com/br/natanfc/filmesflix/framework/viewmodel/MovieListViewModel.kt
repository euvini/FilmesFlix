...
import com.br.natanfc.filmesflix.implamentation.MovieDataSourceImplamentation
...
class MovieListViewModel: ViewModel() {
    ...
    private val movieDataSource = MovieDataSourceImplamentation(movieRestApiTask)
